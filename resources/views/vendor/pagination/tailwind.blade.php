                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-[#994d51] border border-[#994d51] cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600 hover:bg-[#864448]">{{ $page }}</span>
                                    </span>
                                @else
                                    <a href="{{ $url }}"
